...
ActiveRecord::Schema[7.2].define(version: 2025_02_12_181807) do
  ...
  create_table "wallets_allocations", force: :cascade do |t|
    ...
    t.check_constraint "amount > 0", name: "check_wallets_allocations_amount_positive"
  end
  ...
  create_table "wallets_transactions", force: :cascade do |t|
    ...
    t.check_constraint "amount <> 0", name: "check_wallets_transactions_amount_nonzero"
  end
  ...
  create_table "wallets_transfers", force: :cascade do |t|
    ...
    t.check_constraint "amount > 0", name: "check_wallets_transfers_amount_positive"
    t.check_constraint "from_wallet_id <> to_wallet_id", name: "check_wallets_transfers_distinct_wallets"
  end
